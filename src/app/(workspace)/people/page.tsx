...
function AlertMetricCell({
  ...
  return (
    <div className="min-w-0 overflow-hidden rounded-[20px] border border-slate-200 bg-white/82 px-4 py-3 shadow-[0_14px_30px_-24px_rgba(35,58,79,0.16)]">
...
function AlertCard({
  ...
  return (
    <div
      className={cn(
        "overflow-hidden rounded-[32px] border p-6 shadow-[0_24px_70px_-42px_rgba(35,58,79,0.24)]",
    ...
    >
      <div className="flex flex-col gap-5 xl:flex-row xl:items-start xl:justify-between">
        ...
        <div className="grid min-w-0 gap-3 sm:grid-cols-2 xl:w-[320px] xl:shrink-0">
